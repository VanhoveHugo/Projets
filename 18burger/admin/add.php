...
<body>
    ...
    <main>
        <form class="admin" method="POST" action="../core/add.php" enctype='multipart/form-data'>
            <table>
                <tr>
                    <td><label for="name">Nom du burger*:</label></td>
                    <td><input name="name" id="name" type="text"></td>
                </tr>
                <tr>
                    <td><label for="tags">Ingrédients*:</label></td>
                    <td><input name="tags" id="tags" type="text"></td>
                </tr>
                <tr>
                    <td><label for="filename">Image*:</label></td>
                    <td><input name="filename" id="filename" type="text"></td>
                </tr>
                <tr>
                    <td><label for="solo_price">Prix du burger*:</label></td>
                    <td><input name="solo_price" id="solo_price" type="text"></td>
                </tr>
                <tr>
                    <td><label for="menu_price">Prix du menu:</label></td>
                    <td><input name="menu_price" id="menu_price" type="text"></td>
                </tr>
                <tr>
